...
public class AvatarWindowHandler : MonoBehaviour
{
    ...
    void Start()
    {
        // Window-sitting is disabled in this build — shut down the entire component.
        if (SaveLoadHandler.Instance == null || !SaveLoadHandler.Instance.data.enableWindowSitting)
        {
            // Still apply topmost setting before disabling
    ...
    void LateUpdate() { SetTargetQuadActive(false); SetOtherQuadsActive(0); }
