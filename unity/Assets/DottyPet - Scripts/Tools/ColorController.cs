...
public class ColorController : MonoBehaviour
{
    ...
    void Awake()
    {
        ...
        if (targets != null && modelRoot != null)
        {
            ...
            var receiver = activeModel != null ? activeModel.GetComponentInChildren<Animator>() : null;
            if (receiver != null)
            {
                foreach (var t in targets)
                {
                    if (t.target == null) continue;
                    Transform bone = receiver.GetBoneTransform(t.targetBone);
    ...
    void LateUpdate()
    {
        ...
        foreach (var t in targets)
        {
            ...
            if (t.swingMode)
            {
                ...
                Transform bone = currentAnimator.GetBoneTransform(t.targetBone);
                if (bone == null) continue;
